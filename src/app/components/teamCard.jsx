...
const TeamCard = ({classname, name, nickname, role, img}) => {
    return(
        <div className={`${classname} text-center text-[#0A1A18] rounded-[20px] w-[280px] p-[40px] space-y-[24px] text-[20px]`}>
            ...
            <div className="">
                <h1 className=" font-[600] font-clash tracking-[3%] leading-[120%]">{name}</h1>
